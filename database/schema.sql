...
-- ============================================
-- 1. Verification OTPs Table (For pre-registration email verification)
-- ============================================
...
-- ============================================
-- 2. Doctors Table (with OTP fields)
-- ============================================
...
-- Default Doctors (password: doctor123) — pre-verified
INSERT INTO doctors (full_name, email, password, phone, specialization_id, license_number, qualification, experience_years, consultation_fee, bio, verification_status, is_email_verified) VALUES
('Dr. Emilia Winson', 'emilia@mediconnect.com', '$2a$10$TjsO1SCwYNw7TlyPeOqwYuXxLGY0ahnEDthPKbdyYblXLGUqPuBdm', '+1 555-0101', 1, 'LIC-1001', 'MBBS, MD', 12, 500.00, 'Experienced general physician with over 12 years of practice.', 'approved', 1),
('Dr. James Carter', 'james@mediconnect.com', '$2a$10$TjsO1SCwYNw7TlyPeOqwYuXxLGY0ahnEDthPKbdyYblXLGUqPuBdm', '+1 555-0102', 2, 'LIC-1002', 'MBBS, DM Cardiology', 15, 800.00, 'Senior cardiologist specializing in interventional cardiology.', 'approved', 1),
('Dr. Sarah Mitchell', 'sarah@mediconnect.com', '$2a$10$TjsO1SCwYNw7TlyPeOqwYuXxLGY0ahnEDthPKbdyYblXLGUqPuBdm', '+1 555-0103', 3, 'LIC-1003', 'MBBS, MD Dermatology', 8, 600.00, 'Dermatologist with expertise in cosmetic and clinical dermatology.', 'approved', 1);
...
('System Admin', 'admin@mediconnect.com', '$2a$10$o9mTcRarVIzm5fNkz9Ecbet.YQR8doPd.l.TLpxf0JbhhyxvyPATO', 'superadmin');
